...
//---------------------------------------------------------------------------
type
  TLettreChere   = (lchIndefinie, lchJ, lchK, lchQ, lchV, lchW, lchX, lchY, lchZ);
  TValeurChere   = (vchIndefinie, vch8Pts, vch10Pts);
  TTypeRecherche = (trLettre, trValeur);
//---------------------------------------------------------------------------
const
  ValeurChere    : array [TLettreChere] of TValeurChere = (vchIndefinie, vch10Pts, vch10Pts, vch10Pts, vch8Pts, vch10Pts, vch10Pts, vch10Pts, vch8Pts);
  LettreChere    : array ['A'..'Z'] of TLettreChere = (lchIndefinie, lchIndefinie, lchIndefinie, lchIndefinie, lchIndefinie, lchIndefinie, lchIndefinie, lchIndefinie, lchIndefinie,
                                                       ...
                                                       lchQ,
                                                       lchIndefinie, lchIndefinie, lchIndefinie, lchIndefinie,
                                                       lchV, lchW, lchX, lchY, lchZ);
//---------------------------------------------------------------------------
...
var i, j,
    ...
    f           : TextFile;
begin
stNomFichier:=stRepLocalAppData+'listemots.txt'; // stRepLocalAppData remplace ExtractFilePath(Application.ExeName)
...
try
  ...
  RechLch[lchW]:=RadioGroupV.ItemIndex;
