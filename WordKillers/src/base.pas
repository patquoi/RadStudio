...
interface
//----------------------------------------------------------------------------
uses Classes, Graphics, Winapi.Windows, System.IniFiles;
//----------------------------------------------------------------------------
const NbCasesCote         =  15;
   ...
   // MinutesReflexion    = 3; // v1.5.6. Obsolète. Utilisation de TPartie.TempsReflexion à la place
      ...
      stNomFichierIni     = 'WordKillers.ini';
      stSectionSac        = 'Sac';
      stJoker             = '?';
...
type  TBonus = (bAucun,
     ...
     //-----------------------------------------------------------------------
      ...
      public
        ...
        // fonctions de stockage. Pas d'extension : .wkp => Partie. .rtf => Feuille de match en format rtf.
...
//---------------------------------------------------------------------------
const CoefBonusMot    : array [TBonus] of Integer = (1,1,1,2,3,1);
      CoefBonusLettre : array [TBonus] of Integer = (1,2,3,1,1,1);
      BonusCase : array [TCoordonnee, TCoordonnee] of TBonus =
        ((bAucun             , bAucun             , bAucun             , bMotCompteTriple   , bAucun             , bAucun             , bLettreCompteTriple, bAucun             , bLettreCompteTriple, bAucun             , bAucun             , bMotCompteTriple   , bAucun             , bAucun             , bAucun             ),
         (bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bMotCompteDouble   , bAucun             , bAucun             , bAucun             , bMotCompteDouble   , bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             ),
         (bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bAucun             , bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bLettreCompteDouble, bAucun             ),
         (bMotCompteTriple   , bAucun             , bAucun             , bLettreCompteTriple, bAucun             , bAucun             , bAucun             , bMotCompteDouble   , bAucun             , bAucun             , bAucun             , bLettreCompteTriple, bAucun             , bAucun             , bMotCompteTriple   ),
         ...
         (bLettreCompteTriple, bAucun             , bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bAucun             , bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bAucun             , bLettreCompteTriple),
         (bAucun             , bAucun             , bAucun             , bMotCompteDouble   , bAucun             , bAucun             , bAucun             , bCaseCentrale      , bAucun             , bAucun             , bAucun             , bMotCompteDouble   , bAucun             , bAucun             , bAucun             ),
         (bLettreCompteTriple, bAucun             , bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bAucun             , bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bAucun             , bLettreCompteTriple),
         (bAucun             , bMotCompteDouble   , bAucun             , bAucun             , bAucun             , bLettreCompteTriple, bAucun             , bAucun             , bAucun             , bLettreCompteTriple, bAucun             , bAucun             , bAucun             , bMotCompteDouble   , bAucun             ),
         (bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bLettreCompteDouble, bAucun             , bAucun             , bAucun             , bLettreCompteDouble, bAucun             , bAucun             ),
         (bMotCompteTriple   , bAucun             , bAucun             , bLettreCompteTriple, bAucun             , bAucun             , bAucun             , bMotCompteDouble   , bAucun             , bAucun             , bAucun             , bLettreCompteTriple, bAucun             , bAucun             , bMotCompteTriple   ),
      ...
      ValeurJeton   : array [TTypeJeton]   of Integer   = (0,0,1,5,4,3,1,5,5,5,1,10,10,2,4,1,1,4,10,1,1,1,2,8,10,10,10,8);
      ...
      TypeJeton : array [TNumeroJetonSac]    of TTypeJeton = (tjIndefini, tjJoker,
                                                              tjJoker, tjJoker, tjA, tjA, tjA, tjA, tjA, tjA, tjA, tjA, tjA, tjA, tjA, tjA, tjA, tjB, tjB,
                                                                  tjC,     tjC, tjD, tjD, tjD, tjE, tjE, tjE, tjE, tjE, tjE, tjE, tjE, tjE, tjE, tjE, tjE,
                                                                  tjE,     tjF, tjF, tjG, tjG, tjH, tjH, tjI, tjI, tjI, tjI, tjI, tjI, tjI, tjJ, tjK, tjL,
                                                                  tjL,     tjL, tjL, tjM, tjM, tjN, tjN, tjN, tjN, tjN, tjN, tjO, tjO, tjO, tjO, tjO, tjO,
                                                                  tjO,     tjP, tjP, tjQ, tjR, tjR, tjR, tjR, tjR, tjR, tjS, tjS, tjS, tjS, tjS, tjS, tjT,
                                                                  tjT,     tjT, tjT, tjT, tjT, tjU, tjU, tjU, tjU, tjV, tjW, tjX, tjY, tjZ);
...
var p                   : TPartie;
    ...
    Journal             : TextFile;
    stRepLocalAppData, // v1.8.4 : stRepLocalAppData remplace ExtractFilePath(ParamStr(0))
...
const stAutreChoix            = #13#13'Cliquez sur une autre case départ ou changez la sélection des jetons.';
      ...
      stCodeHTMLBonus         : array [TBonus] of String = ('#C0C0C0', '#0000FF', '#00FF00', '#000080', '#FF8000', '#FF00FF'); // v1.3.6 : Déclaration déplacée ici pour utilisation commune avec Liste des Solutions. v1.3.10 : bleu foncé éclairci
...
const stFrmHTMLEnTete = '<?xml version="1.0" encoding="iso-8859-1"?>'#13+
                        ...
                        '<html><head><title>Solutions triées - Word Killers</title><meta content="Solutions triées Word Killers" name="description"><meta content="Solutions triées, Word Killers" name="keywords"></head>'#13+
                        '<body text="#fffff" vlink="#a0a0ff" link="#00ffff" bgcolor="#000000">'#13+
                        '<h1>Solutions triées - Word Killers</h1>'#13;
      ...
      stFrmHTMLPdPPlt = '</tr>'#13'</tbody></table><BR>'#13#13'Tirage au tour n°%d&nbsp;: <B>%S</B>. Nombre de solutions distinctes : %d.<P><U>Remarque</U> : Les lettres en minuscules indiquent les jokers utilisés.<BR>'#13#13; // v1.4.1 (Rq)
      stFrmHTMLETSol  = '<table cellspacing="1" cellpadding="2" border="1"><tbody>'#13+
                        ...
                        '<tr><td><I>Score</I></td><td><I>Jeton(s)<BR>placé(s)</I></td><td><I>Valeur<BR>placée</I></td><td><I>Rang</I></td><td><I>Position(s)<BR>1er jeton du mot</I></td><td><I>Mot(s) posé(s)</I></td></tr>'#13; // v1.7.2. "1er jeton du mot" au lieu de "1er jeton posé"
...
stNomFichierHTML:=stRepLocalAppData+'Solutions.html'; // v1.8.4 : stRepLocalAppData remplace ExtractFilePath(ParamStr(0))

(* // Trace
AssignFile(f, stRepLocalAppData+'\Trace.txt'); // v1.8.4 : stRepLocalAppData remplace ExtractFilePath(ParamStr(0))
Rewrite(f);
...
try
  with FormPatience do
    ...
    Gauge.MaxValue:=(NbLettresDico div 5)-1; // v1.8 (ODS7)
    Gauge.MinValue:=0;
    Gauge.Progress:=Gauge.MinValue;
    Show;
    Panel.Repaint;
...
for iSelection:=Debut to Fin do
  if Chevalet[iSelection]>0 then
    ...
    if not MotForme90Valable(X+iPlateau*dx[d],
                             ...
                             stMot90) and
       ((TypeProposition=tpRecherche) or (Paramstr(1)<>'!')) then // vWK : '!' permet de passer outre la non validité d'un mot (proposition)
      begin
      Result:=False;
      if TypeProposition<>tpRecherche then
        begin
...
//---------------------------------------------------------------------------
// fonctions de stockage. extension .wkp => Partie ; .rtf => Feuille de match en format rtf.
//---------------------------------------------------------------------------
...
try
  ...
  for i:=Low(TTour) to High(TTour) do
    ...
    for j:=1 to k do
      BlockWrite(f, stProposition[i,j], 1); // v1.8.3 : caractères 8 bits stockés
    k:=Length(stSolution[i]);
    BlockWrite(f, k, SizeOf(k));
    for j:=1 to k do
      BlockWrite(f, stSolution[i,j], 1); // v1.8.3 : caractères 8 bits stockés
    k:=Length(stTirage[i]);
    BlockWrite(f, k, SizeOf(k));
    for j:=1 to k do
      BlockWrite(f, stTirage[i,j], 1); // v1.8.3 : caractères 8 bits stockés
    end;
  if VersionFichier>=$156 then // v1.5.6
    begin
...
try
  ...
  if (VersionFichier<>$140) and
    ...
    stMessage:='Ce n''est pas un fichier de partie Word Killers ou le fichier a été généré avec une version de Word Killers antérieure à la version 1.4.';
    Exit
    end;
  if VersionFichier>VersionFichierCrt then // v1.5
    begin
    stMessage:='Cette partie a été enregistrée avec une version ultérieure à la version actuelle de Word Killers.';
    Exit
    end;
  for i:=Low(TCoordonnee) to High(TCoordonnee) do
    for j:=Low(TCoordonnee) to High(TCoordonnee) do
  ...
  for i:=Low(TTour) to High(TTour) do
    ...
    for j:=1 to k do
      begin
      BlockRead(f, l[1], 1); // v1.8.3 : caractères 8 bits stockés
...
var x, y,
  ...
  var i : Integer;
      ...
      Lettre1, Lettre2, Lettre3 : Char; // vWK (Lettre3)
    ...
    for Lettre1:='A' to 'Z' do
      ...
      if NbJokers>1 then
        for Lettre2:='A' to 'Z' do
          ...
          if NbJokers>2 then // vWK 3 jokers
            for Lettre3:='A' to 'Z' do
              begin
              stTirage[iJoker[3]]:=Lettre3;
              LettreJoker[NumeroJoker[3]]:=TTypeJeton(Ord(tjA)+Ord(Lettre3)-Ord('A'));
              Etape7;
              end
          else
            Etape7;
...
try
  ...
  FreeAndNil(IniFile);
  GenereListeDefis(stRepLocalAppData+stNomFichierDefi1M15L, NAffichePas); // v1.8.4 : stRepLocalAppData remplace ExtractFilePath(ParamStr(0))
end{try}
end;
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
initialization
  FileMode:=fmOpenRead; // v1.8.4 : les fichiers ouverts avec Reset sont en lecture seule.
  Journalisation:=False;
  JournalOuvert:=False; // v1.5 : Empêche le Try CloseFile(Journal)
  InitialiseRepLocalAppData; // v1.8.4 : stRepLocalAppData remplace ParamStr(0)
  stNomFichierJournal:=ExtractFilePath(ParamStr(0))+'wordkillers.log';
