object FormMain: TFormMain
  ...
  object ActionList: TActionList
    ...
    object ActionAffichagePartiesJouees: TAction
      ...
      Hint = 'Affiche les infos sur les parties jo'#233'es termin'#233'es'
      ShortCut = 16469
    ...
    object ActionOptionsReinitialiser: TAction
      ...
      Hint = 'R'#233'tablit les param'#232'tres par d'#233'faut de r'#232'gles et d'#39'affichage'
      ShortCut = 16474
  ...
  object OpenDialog: TOpenDialog
    ...
    DefaultExt = 'dup'
    Filter = 'Partie Word Killers (*.wkp)|*.wkp'
    Options = [ofHideReadOnly, ofPathMustExist, ofFileMustExist, ofEnableSizing]
    Title = 'S'#233'lectionner le fichier de partie Word Killers sauvegard'#233'e'
    Left = 112
    Top = 8
  end
