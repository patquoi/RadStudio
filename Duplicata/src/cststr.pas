...
const stHTMLSansNom    ='[Sans nom]'; stHTMLItaliqueSansNom='<I>'+stHTMLSansNom+'</I>';
      stHTMLImgNivDiff ='<img src="%s" width=55 height=13 title="%s">'; // v1.8.8 alt remplacé par title pour affichage bulle d'aide
      ...
      stFrmHTMLFdmdEnT1='<?xml version="1.0" encoding="iso-8859-1"?>'#13+'<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">'#13+
                        '<html><head><title>Feuille de match détaillée - Duplicata</title><meta content="Feuille de match détaillée Duplicata" name="description"><meta content="Feuille de match détaillée, Duplicata" name="keywords"></head>'#13+'<body text="#fffff" vlink="#a0a0ff" link="#00ffff" bgcolor="#000000">'#13+
                        '<center><h1>Feuille de match détaillée - Duplicata</h1></center>'#13'<table cellspacing="1" cellpadding="2" border="1"><tbody>'#13+
      ...
      stFrmHTMLLdPJEnT= '<?xml version="1.0" encoding="iso-8859-1"?>'#13+
                        ...
                        '<html><head><title>Parties jouées - Duplicata</title><meta content="Parties jouées Duplicata" name="description"><meta content="Parties jouées, Duplicata" name="keywords"></head>'#13+
                        '<body text="#fffff" vlink="#a0a0ff" link="#00ffff" bgcolor="#000000">'#13+
                        '<center><h1>Parties jouées - Duplicata</h1></center>'#13+
                        '<table cellspacing="1" cellpadding="2" border="1"><tbody>'#13+
      ...
      stFrmHTMLLdPJPdP2='<tr><td><I>Score Joué</I></td><td>Score de la partie concernant uniquement les propositions placées sur le plateau de jeu.</td></tr>'#13+                        '<tr><td><I>Score Top</I></td><td>Score Top de la partie (cumul des scores des meilleurs coups possibles à chaque tour).</td></tr>'#13'<tr><td><I>Temps</I></td><td>Temps de réflexion écoulé durant la partie.</td></tr>'#13+                        '<tr><td><I>Rang</I></td><td>Position moyenne des propositions du joueur dans le classement de toutes les solutions possibles selon l''ordre décroissant de leur score.</td></tr>'#13+
                        ...
                        '('#42') Niveau de difficulté pondéré sur le nombre de solutions (Parties jouées avec la version 1.5 de Duplicata) et non le score top (versions 1.5.1 ou ultérieures).</td></tr>'#13+
      ...
      stFrmHTMLD15lEnT= '<?xml version="1.0" encoding="iso-8859-1"?>'#13+
                        '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">'#13+
                        '<html><head><title>Défi Duplicata n°1 : Former un mot de 15 lettres avec le moins de jetons possible</title><meta content="Défi n°1 Duplicata" name="description"><meta content="Défi n°1, Duplicata" name="keywords"></head>'#13+
                        '<body text="#fffff" vlink="#a0a0ff" link="#00ffff" bgcolor="#000000">'#13+
                        '<center><h1>Défi Duplicata n°1&nbsp;:<br>Former un mot de 15 lettres avec le moins de jetons possible</h1></center>'#13+
