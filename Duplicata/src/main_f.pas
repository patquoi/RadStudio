...
if stNomFichierPartie='' then
  if ActionOptionsGenererAutoFDM.Tag=0 then // v1.3.5
    stNomFichierFdMD:=stRepLocalAppData+'Duplicata.dup' // v1.8.4 : stRepLocalAppData remplace ExtractFilePath(ParamStr(0))
  else
    begin
...
begin // v1.5.3
d15l.GenereListeDefis(stRepLocalAppData+ // v1.8.7 : oubli de remplacer ExtractFilePath(Application.ExeName) par stRepLocalAppData
...
// v1.8.4 : affichage 32/64 bits dans les informations internes après la version de Duplicata
const stFrmInfoPartie = 'Partie'#13#13' · Nom : %s.'#13' · Numéro : %s.'#13' · Version du format de fichier de partie : %3X.'#13' · Type de partie : %s.'#13' · Temps de réflexion : %s.'#13#13+
                        'Duplicata'#13#13' · Version : %s (%d bits)'#13' · Prochain n° de partie : %d.'#13' · Version courante du format de fichier de partie : %X.'#13' · Type de partie : %s.'#13' · Temps de réflexion : %s.';
begin // v1.5.3
...
begin
stNomFichierJournal:=stRepLocalAppData+'duplicata.log'; // v1.8.4 : stRepLocalAppData remplace ExtractFilePath(ParamStr(0))
...
begin
OpenDialog.InitialDir:=stRepLocalAppData // v1.8.7 : oubli de remplacer ExtractFilePath(Application.ExeName) par stRepLocalAppData
end;
//---------------------------------------------------------------------------
procedure TFormMain.SaveDialogShow(Sender: TObject);
begin
SaveDialog.InitialDir:=stRepLocalAppData // v1.8.7 : oubli de remplacer ExtractFilePath(Application.ExeName) par stRepLocalAppData
end;
//---------------------------------------------------------------------------
