...
const
      ...
      nbl : array [TNbLettres] of Integer = (160,1863,10256,39115,106086,221718,377272,525897,615870,621093,543948,417651,285012,176565); // (ODS7 corrigé)
...
stNomFichier:=ExtractFilePath(ParamStr(0))+'ods7\'+stNomFichierDico;
...
//---------------------------------------------------------------------------
destructor TDico7.Detruit;
begin
end;
//---------------------------------------------------------------------------
function TDico7.stMotDico(const TailleMot, IndexDico : Integer) : String;
var i : Integer;
begin
Result:='';
...
//---------------------------------------------------------------------------
function TDico7.Existe(const stMot : String) : Boolean;
...
//---------------------------------------------------------------------------
function TDico7.IndexProchainMot(const IndexDebut : Integer; const stFiltre : String) : Integer;
