...
implementation
//---------------------------------------------------------------------------
uses Winapi.ShellApi, main_f, base, langue;
//---------------------------------------------------------------------------
{$R *.dfm}
//----------------------------------------------------------------------------
...
begin // v1.5.3.
Memo.Text:=StringReplace(Memo.Text, 'ODS', Format('%s (%d entrées)', [stVersionDico, NbEntreesDico]), [rfReplaceAll]); // vKA
GenereFichierFRIni(self); //v1.8 gestion multilingue
// v1.7.4 : affichage 32/64 bits dans l'À propos
{$IFDEF WIN32}
