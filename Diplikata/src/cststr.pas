...
// v1.7.4 : Remplacement de alt par title pour affichage bulle d'aide dans les niveaux de difficulté
//---------------------------------------------------------------------------
const stHTMLSansNom    ='[Sans nom]'; stHTMLItaliqueSansNom='<I>'+stHTMLSansNom+'</I>';
      stHTMLImgNivDiff ='<img src="%s" width=55 height=13 title="%s">'; // v1.7.4 alt remplacé par title pour affichage bulle d'aide
      ...
      stFrmHTMLFdmdEnT1='<?xml version="1.0" encoding="iso-8859-1"?>'#13+'<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">'#13+
                        '<html><head><title>Feuille de match détaillée - Diplikata</title><meta content="Feuille de match détaillée Diplikata" name="description"><meta content="Feuille de match détaillée, Diplikata" name="keywords"></head>'#13+'<body text="#fffff" vlink="#a0a0ff" link="#00ffff" bgcolor="#000000">'#13+
                        '<center><h1>Feuille de match détaillée - Diplikata</h1></center>'#13'<table cellspacing="1" cellpadding="2" border="1"><tbody>'#13+
                        '<tr><td COLSPAN=2 align="center"><I>Tirage</I></td><td COLSPAN=2 align="center"><I>Proposition</I></td><td COLSPAN=2 align="center">';
                        // vKA : ajout en-tête Tirage (ci-dessus) et déplacement de "T." et "Tirage" (de ci-dessus à ci-dessous)
      ...
      stFrmHTMLFdmdEnT2='<I>Solution jouée</I></td>'+'<td COLSPAN=3 align="center"><I>Score Tour</I></td>'+'<td COLSPAN=3 align="center"><I>Score Partie</I></td>'+'<td COLSPAN=2 align="center"><I>Tps réflexion</I></td>'+'<td COLSPAN=15 align="center"><I>Statistiques</I></td></tr>'#13+
                        '<tr><td align="center" ROWSPAN=2><I>T.</I></td>'+'<td align="center" ROWSPAN=2><I>Tirage</I></td>'+'<td align="center" ROWSPAN=2><I>Pos.</I></td>'+'<td ROWSPAN=2><I>Mot<br>principal</I></td>'+'<td align="center" ROWSPAN=2><I>Pos.</I></td>'+'<td ROWSPAN=2><I>Mot<br>principal</I></td>'+'<td ROWSPAN=2><I>Prp</I></td>'+'<td ROWSPAN=2><I>Joué</I></td>'+'<td ROWSPAN=2><I>Top</I></td>'+'<td ROWSPAN=2><I>Prp</I></td>'+'<td ROWSPAN=2><I>Joué</I></td>'+'<td ROWSPAN=2><I>Top</I></td>'+'<td ROWSPAN=2 align="center"><I>Tour</I></td>'+'<td ROWSPAN=2 align="center"><I>Partie</I></td>'+'<td ROWSPAN=2><I>Rang</I></td>'+'<td ROWSPAN=2><I>Solutions</I></td>'+'<td ROWSPAN=2><I>Dont<br>B.50</I></td>'+'<td ROWSPAN=2><I>Niveau de<br>difficulté</I></td>'+'<td ROWSPAN=2><I>Rech.<br>sol.(s)</I></td>'+'<td ROWSPAN=2><I>Nb Sol./s</I></td>'+'<td COLSPAN=7 align="center"><I>Moyennes</I></td>'+'<td COLSPAN=2 align="center"><I>Scores%s</I></td></tr>'#13+
      ...
      stFrmHTMLFdmdPdP3='<tr><td><I>Rech.sol.</I></td><td>Temps nécessaire qu''il a fallu pour calculer toutes les solutions (exprimé en secondes). Information pour les parties générées avec une version 1.6 ou ultérieure uniquement.</td></tr>'#13+
                        ...
                        '<tr><td><U>JETON</U></td><td>Jeton (souligné) posé sur le plateau de jeu.</td></tr>'#13+
                        '<tr><td><U><FONT COLOR="#0000FF">J</FONT><FONT COLOR="#00FFFF">E</FONT><FONT COLOR="#FFC0C0">T</FONT><FONT COLOR="#FF0000">O</FONT>'+
                        '<FONT COLOR="#4040FF">N</FONT>'+
                        '</U></td><td>Jeton (coloré) posé sur une case bonus de la même couleur.</td></tr>'#13+
                        '<tr><td><I>JETON</I></td><td>Jeton (en italique) qui vient d''être tiré du sac.</td></tr>'#13+
                        '<tr><td><FONT COLOR="#404040">JETON</FONT></td><td>Jeton attribué à un joker lors de la pose.</td></tr>'#13+
                        '<tr><td>lettre</td><td>Deuxième lettre (en minuscule) : jeton à double lettre (An, Ch, En, Ng, On, Ou, Ui).</td></tr>'#13+
                        '<tr><td><FONT COLOR="#00FF00">JETON</FONT></td><td>Jeton échangé avec un joker (parties "joker" uniquement).</td></tr>'#13+
                        '<tr><td>?</td><td>Jeton du tirage correspondant à un joker (non encore utilisé).</td></tr>'#13+
      ...
      stFrmHTMLFdmdLgn ='<tr><td align="right">%d.</td><td>%s</td>'+
      ...
      stFrmHTMLLdPJEnT= '<?xml version="1.0" encoding="iso-8859-1"?>'#13+
                        ...
                        '<html><head><title>Parties jouées - Diplikata</title><meta content="Parties jouées Diplikata" name="description"><meta content="Parties jouées, Diplikata" name="keywords"></head>'#13+
                        '<body text="#fffff" vlink="#a0a0ff" link="#00ffff" bgcolor="#000000">'#13+
                        '<center><h1>Parties jouées - Diplikata</h1></center>'#13+
                        '<table cellspacing="1" cellpadding="2" border="1"><tbody>'#13+
      ...
      stFrmHTMLLdPJPdP2='<tr><td><I>Score Joué</I></td><td>Score de la partie concernant uniquement les propositions placées sur le plateau de jeu.</td></tr>'#13+
                        ...
                        '('#42') Niveau de difficulté pondéré sur le nombre de solutions (Parties jouées avec la version 1.5 de Diplikata) et non le score top (versions 1.5.1 ou ultérieures).</td></tr>'#13+
      ...
      stFrmHTMLD15lEnT= '<?xml version="1.0" encoding="iso-8859-1"?>'#13+
                        '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">'#13+
                        '<html><head><title>Défi Diplikata n°1 : Former un mot de 15 lettres avec le moins de jetons possible</title><meta content="Défi n°1 Diplikata" name="description"><meta content="Défi n°1, Diplikata" name="keywords"></head>'#13+
                        '<body text="#fffff" vlink="#a0a0ff" link="#00ffff" bgcolor="#000000">'#13+
                        '<center><h1>Défi Diplikata n°1&nbsp;:<br>Former un mot de 15 lettres avec le moins de jetons possible</h1></center>'#13+
                        'Voici la liste des défis relevés. La liste est triée par ordre décroissant de valeur des mots puis par ordre alphabétique.<br>Vous trouverez la liste complète des mots <A HREF="./html/top15KA.txt">ici</A>.<br>'+' Le mot le plus difficile à placer jusqu''à ce jour apparaît en <b>gras</b>.<P>'#13+
                        '<table cellspacing="1" cellpadding="2" border="1"><tbody>'#13+
      ...
      stFrmHTMLD15lPdp= '</tbody></table>'#13'('#42') Dernier coup du mot de 15 jetons <b>exclu</b>.'#13+
                        '<H2>Légende</H2>'#13+
                        '<table cellspacing="1" cellpadding="2" border="1"><tbody>'#13+
                        '<tr><th>Nature</th><th>Description</th>'#13+
                        '<tr><td><b>Valeur</b></td><td>Cumul de la valeur des lettres du mot de quinze jetons, hors bonus et jokers</td></tr>'#13+
                        '<tr><td><b>Jetons</b></td><td>Nombre de jetons posés ne faisant pas partie du mot de quinze jetons</td></tr>'#13+
                        '<tr><td><b>Coups</b></td><td>Nombre de coups de préparation qu''il a fallu avant de pouvoir poser le mot de quinze jetons</td></tr>'#13+
                        '<tr><td><b>Score</b></td><td>Score obtenu lors de la pose du mot de quinze jetons</td></tr>'#13+
                        '<tr><td><b>Cumul</b></td><td>Cumul des scores avant la pose du mot de quinze jetons</td></tr>'#13+
