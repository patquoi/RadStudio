...
begin
// v1.3 : affichage HDPI
LabelDPI.Caption:='HDPI: x'+Format('%.1f', [Screen.PixelsPerInch/96]);
// v1.3 : affichage 32/64 bits
{$IFDEF WIN32}
Label32ou64Bits.Caption:=StringReplace(Label32ou64Bits.Caption, 'yy', '32', [rfReplaceAll]);
{$ENDIF}
{$IFDEF WIN64}
Label32ou64Bits.Caption:=StringReplace(Label32ou64Bits.Caption, 'yy', '64', [rfReplaceAll]);
{$ENDIF}
DetermineVersion
end;
//-----------------------------------------------------------------------------
