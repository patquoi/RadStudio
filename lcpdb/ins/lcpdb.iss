[Icons]
Name: {group}\Le Compte Pour De Bon; Filename: {app}\bin\lcpdb.exe; WorkingDir: {commondesktop}; IconFilename: {app}\bin\lcpdb.exe; Comment: Atelier du célèbre jeu télévisé; IconIndex: 0; Components: ; Languages: 
...
Name: {group}\Lisez-moi !; Filename: {app}\lisezmoi.txt; Comment: Fichier à lire en premier !
Name: {group}\Statistiques; Filename: {app}\bin\Statistiques.html; Comment: Statistiques cumulées
Name: {group}\Désinstallation; Filename: {app}\unins000.exe; WorkingDir: {app}; IconFilename: {app}\lcpdbX.ico; Comment: Désinstalle le Compte Pour De Bon
[Setup]
...
AppComments=Licence Publique Générale 2.0
